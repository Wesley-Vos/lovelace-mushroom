...
import { ClimateCardConfig, climateCardConfigStruct, HVAC_MODES, PRESET_MODES } from "./climate-card-config";

const CLIMATE_LABELS = ["hvac_modes", "preset_modes", "show_temperature_control"] as string[];
